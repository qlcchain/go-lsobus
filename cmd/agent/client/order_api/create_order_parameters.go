...
func (o *CreateOrderParams) WithBody(body *models.ProtoCreateOrderParam) *CreateOrderParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create order params
func (o *CreateOrderParams) SetBody(body *models.ProtoCreateOrderParam) {
	o.Body = body
}

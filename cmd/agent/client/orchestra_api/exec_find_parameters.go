...
// NewExecFindParams creates a new ExecFindParams object
// with the default values initialized.
func NewExecFindParams() *ExecFindParams {
	var ()
	return &ExecFindParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewExecFindParamsWithTimeout creates a new ExecFindParams object
...
// NewExecFindParamsWithContext creates a new ExecFindParams object
...
// NewExecFindParamsWithHTTPClient creates a new ExecFindParams object
...
/*ExecFindParams contains all the parameters to send to the API endpoint
for the exec find operation typically these are written to a http.Request
*/
...
func (o *ExecFindParams) WithBody(body *models.ProtoOrchestraCommonRequest) *ExecFindParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the exec find params
func (o *ExecFindParams) SetBody(body *models.ProtoOrchestraCommonRequest) {
	o.Body = body
}

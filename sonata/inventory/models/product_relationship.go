...
func (m *ProductRelationship) validateProduct(formats strfmt.Registry) error {
...
func (m *ProductRelationship) validateType(formats strfmt.Registry) error {

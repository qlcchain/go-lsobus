...
func (m *FormattedAddress) validateID(formats strfmt.Registry) error {
...
func (m *FormattedAddress) validateAddrLine1(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addrLine1", "body", string(*m.AddrLine1), 25); err != nil {
		return err
	}
...
func (m *FormattedAddress) validateAddrLine2(formats strfmt.Registry) error {

	if swag.IsZero(m.AddrLine2) { // not required
		return nil
	}

	if err := validate.MaxLength("addrLine2", "body", string(m.AddrLine2), 25); err != nil {
		return err
	}
...
func (m *FormattedAddress) validateLocality(formats strfmt.Registry) error {
...
func (m *FormattedAddress) validatePostcodeExtension(formats strfmt.Registry) error {

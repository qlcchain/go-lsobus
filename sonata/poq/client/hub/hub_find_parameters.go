...
// NewHubFindParams creates a new HubFindParams object
// with the default values initialized.
func NewHubFindParams() *HubFindParams {

	return &HubFindParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewHubFindParamsWithTimeout creates a new HubFindParams object
...
// NewHubFindParamsWithContext creates a new HubFindParams object
...
// NewHubFindParamsWithHTTPClient creates a new HubFindParams object
...
/*HubFindParams contains all the parameters to send to the API endpoint
for the hub find operation typically these are written to a http.Request
*/

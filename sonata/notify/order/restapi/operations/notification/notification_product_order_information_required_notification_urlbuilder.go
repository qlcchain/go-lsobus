...
func (o *NotificationProductOrderInformationRequiredNotificationURL) Build() (*url.URL, error) {
	...
	var _path = "/notification/productOrderInformationRequiredNotification"
...
func (o *NotificationProductOrderInformationRequiredNotificationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on NotificationProductOrderInformationRequiredNotificationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on NotificationProductOrderInformationRequiredNotificationURL")
	}

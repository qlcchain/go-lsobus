...
func (o *NotificationProductOrderStateChangeNotificationURL) Build() (*url.URL, error) {
	...
	var _path = "/notification/productOrderStateChangeNotification"
...
func (o *NotificationProductOrderStateChangeNotificationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on NotificationProductOrderStateChangeNotificationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on NotificationProductOrderStateChangeNotificationURL")
	}

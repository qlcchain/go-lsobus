...
func init() {
	...
	if err := json.Unmarshal([]byte(`["acknowledged","rejected","inProgress","pending","held","assessingCancellation","pendingCancellation","cancelled","inProgress.configured","failed","completed"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {

...
func (o *NotificationProductOrderAttributeValueChangeNotificationURL) Build() (*url.URL, error) {
	...
	var _path = "/notification/productOrderAttributeValueChangeNotification"

	_basePath := o._basePath
	if _basePath == "" {
		_basePath = "/api/mef/productOrderNotification/v3/"
	}
...
func (o *NotificationProductOrderAttributeValueChangeNotificationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on NotificationProductOrderAttributeValueChangeNotificationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on NotificationProductOrderAttributeValueChangeNotificationURL")
	}

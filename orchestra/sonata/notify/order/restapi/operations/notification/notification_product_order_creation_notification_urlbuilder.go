...
func (o *NotificationProductOrderCreationNotificationURL) Build() (*url.URL, error) {
	...
	var _path = "/notification/productOrderCreationNotification"
...
func (o *NotificationProductOrderCreationNotificationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on NotificationProductOrderCreationNotificationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on NotificationProductOrderCreationNotificationURL")
	}

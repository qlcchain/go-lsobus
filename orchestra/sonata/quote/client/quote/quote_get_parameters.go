...
func NewQuoteGetParams() *QuoteGetParams {
	var ()
	return &QuoteGetParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewQuoteGetParamsWithTimeout creates a new QuoteGetParams object
...
// NewQuoteGetParamsWithContext creates a new QuoteGetParams object
...
// NewQuoteGetParamsWithHTTPClient creates a new QuoteGetParams object
...
/*QuoteGetParams contains all the parameters to send to the API endpoint
for the quote get operation typically these are written to a http.Request
*/

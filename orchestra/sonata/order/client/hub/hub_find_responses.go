...
func (o *HubFindReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 405:
		result := NewHubFindMethodNotAllowed()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 422:
		...
		return nil, result
	case 500:
		result := NewHubFindInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewHubFindMethodNotAllowed() *HubFindMethodNotAllowed {
	return &HubFindMethodNotAllowed{}
}
...
func (o *HubFindMethodNotAllowed) Error() string {
	return fmt.Sprintf("[GET /hub][%d] hubFindMethodNotAllowed  %+v", 405, o.Payload)
}

func (o *HubFindMethodNotAllowed) GetPayload() *models.ErrorRepresentation {
	return o.Payload
}

func (o *HubFindMethodNotAllowed) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewHubFindInternalServerError() *HubFindInternalServerError {
	return &HubFindInternalServerError{}
}
...
func (o *HubFindInternalServerError) Error() string {
	return fmt.Sprintf("[GET /hub][%d] hubFindInternalServerError  %+v", 500, o.Payload)
}

func (o *HubFindInternalServerError) GetPayload() *models.ErrorRepresentation {
	return o.Payload
}

func (o *HubFindInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
